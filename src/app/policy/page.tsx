export default function PolicyPage() {
  return (
    <div className="w-full flex justify-center items-center text-balance">
      <div className="flex-col w-1/2 my-8">
        <h1 className="font-bold text-2xl">Privacy Policy</h1>
        <p className="font-bold text-lg">Last updated: March 16, 2024</p>
        <h2 className="font-semibold text-xl mt-2">
          Interpretation and Definitions
        </h2>
        <h3 className="font-semibold text-xl mt-2">Interpretation</h3>
        ...
        <h3 className="font-semibold text-xl mt-2">Definitions</h3>
        <p className="leading-relaxed mt-2">
        ...
        <ul className="list-outside list-disc">
          ...
          <li className="ml-8 mt-2">
            ...
            this Agreement) refers to Hallucination Guys.
          </li>
          <li className="ml-8 mt-2">
          ...
          <li className="ml-8 mt-2">
            <strong>Website </strong> refers to Hallucination Guys, accessible
            from{' '}
            <a
              href="hallucinationguys.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              hallucinationguys.com
            </a>
          </li>
          <li className="ml-8 mt-2">
        ...
        <h3 className="font-semibold text-xl mt-2">Types of Data Collected</h3>
        <h4 className="font-semibold text-xl mt-2">Personal Data</h4>
        <p className="leading-relaxed mt-2">
        ...
        <ul className="list-outside list-disc">
          <li className="ml-8 mt-2">
            <p className="font-semibold leading-relaxed mt-2">Email address</p>
          </li>
          <li className="ml-8 mt-2">
          ...
          <li className="ml-8 mt-2">
            <p className="font-semibold leading-relaxed mt-2">Phone number</p>
          </li>
          <li className="ml-8 mt-2">
            <p className="font-semibold leading-relaxed mt-2">
          ...
          <li className="ml-8 mt-2">
            <p className="font-semibold leading-relaxed mt-2">Usage Data</p>
          </li>
        </ul>
        <h4 className="font-semibold text-xl mt-2">Usage Data</h4>
        <p className="leading-relaxed mt-2">
        ...
        <ul className="list-outside list-disc">
          <li className=" font-semibold ml-8 mt-2">Google</li>
          <li className=" font-semibold ml-8 mt-2">Facebook</li>
          <li className=" font-semibold ml-8 mt-2">Instagram</li>
          <li className=" font-semibold ml-8 mt-2">Twitter</li>
          <li className=" font-semibold ml-8 mt-2">LinkedIn</li>
        </ul>
        <p className="leading-relaxed mt-2">
        ...
        <ul>
          <li className="ml-8 mt-2">
            ...
            <p className="leading-relaxed mt-2">Type: Session Cookies</p>
            <p className="leading-relaxed mt-2">Administered by: Us</p>
            <p className="leading-relaxed mt-2">
          ...
          <li className="ml-8 mt-2">
            ...
            <p className="leading-relaxed mt-2">Type: Persistent Cookies</p>
            <p className="leading-relaxed mt-2">Administered by: Us</p>
            <p className="leading-relaxed mt-2">
        ...
        <h4 className="font-semibold text-xl mt-2">Business Transactions</h4>
        <p className="leading-relaxed mt-2">
        ...
        <h4 className="font-semibold text-xl mt-2">Law enforcement</h4>
        <p className="leading-relaxed mt-2">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="font-semibold text-xl mt-2">Other legal requirements</h4>
        <p className="leading-relaxed mt-2">
          The Company may disclose Your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul className="list-outside list-disc">
          <li className="ml-8 mt-2">Comply with a legal obligation</li>
          <li className="ml-8 mt-2">
          ...
          <li className="ml-8 mt-2">Protect against legal liability</li>
        </ul>
        <h3 className="font-semibold text-xl mt-2">
        ...
        <h2 className="font-semibold text-xl mt-2">Children's Privacy</h2>
        <p className="leading-relaxed mt-2">
        ...
        <h2 className="font-semibold text-xl mt-2">Links to Other Websites</h2>
        <p className="leading-relaxed mt-2">
        ...
        <h2 className="font-semibold text-xl mt-2">Contact Us</h2>
        <p className="leading-relaxed mt-2">
        ...
        <ul className="list-outside list-disc">
          <li className="ml-8 mt-2">
            <p className="leading-relaxed mt-2">
              By email: datnguyennnx@gmail.com
            </p>
          </li>
          <li className="ml-8 mt-2">
            <p className="leading-relaxed mt-2">
              ...
              <a
                href="hallucinationguys.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                hallucinationguys.com/contact
              </a>
            </p>
          </li>
        </ul>
